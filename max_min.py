...
u=[-2.6,0.6,-0.60,1.9,-1.9, -0.1,0.5,0.8,-0.6,3.5,0.1,-0.5, -1.4, -2.7,-0.4,2.5, -0.4,3.5,0.47429285,-0.12023724, -2.2519852,   0.4648014,   2.32858834, -1.19293194, -0.19579339, -0.86913637, -2.58153747,  3.14923591, -0.05098814, -2.40119943, 1.60367566]
...
uc =[max(0,num) for num in u]
ud = [-1*min(0,num) for num in u]
#uc.sort()
